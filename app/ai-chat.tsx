...
export default function AiChatScreen() {
  ...
  const [messages, setMessages] = useState<Message[]>(() => [
    {
      id: 0, from: 'ai', time: '오후 2:10',
      text: '안녕하세요! 저는 상황을 요약하고 관련 컨텐츠를 찾아드리는 아이로 AI 챗봇입니다.\n\n⚠️ 심각하거나 긴급한 상황이라면:\n• Q&A 게시판을 통해 변호사님께 직접 질문하세요\n• 즉시 112(경찰)로 전화하세요\n\n지금 겪고 있는 상황을 말씀해주시면, 관련 정보를 찾아드릴게요.',
    },
    {
      id: 1, from: 'user', time: '오후 2:11',
      text: '알바하다가 사장님이 일방적으로 그만두라고 했어요. 한 달 치 월급도 안 주고요. 어떻게 해야 하나요?',
    },
    {
      id: 2, from: 'ai', time: '오후 2:11',
      summary: '사용자는 아르바이트 중 사용자가 동의하지 않은 일방적 해고를 당했으며, 이에 더해 한 달치 임금을 지급받지 못한 상황입니다. 부당해고 및 임금체불이 동시에 발생한 사례로 보입니다.',
      suggestions: [
        { type: 'manual', id: 348, label: '갑자기 해고당했는데 문제없나요?' },
        { type: 'manual', id: 352, label: '사장님이 월급을 주지 않는데 어떻게 해야 하나요?' },
        { type: 'qna', id: 6, label: '알바비를 안 주는데 어떻게 해야 하나요?' },
      ],
    },
  ]);
